...
func getPackageByCodecName(name string) string {
	switch name {
	case "gorillaws.ltv":
		return "github.com/fangjie-luoxi/cellnet/proc/gorillaws"
	case "http":
		return "github.com/fangjie-luoxi/cellnet/proc/http"
	case "tcp.ltv":
		return "github.com/fangjie-luoxi/cellnet/proc/tcp"
	case "udp.ltv":
		return "github.com/fangjie-luoxi/cellnet/proc/udp"
	default:
