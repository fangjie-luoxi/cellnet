...
func getPackageByCodecName(name string) string {
	switch name {
	case "binary":
		return "github.com/fangjie-luoxi/cellnet/codec/binary"
	case "gogopb":
		return "github.com/fangjie-luoxi/cellnet/codec/gogopb"
	case "httpjson":
		return "github.com/fangjie-luoxi/cellnet/codec/httpjson"
	case "json":
		return "github.com/fangjie-luoxi/cellnet/codec/json"
	case "protoplus":
		return "github.com/fangjie-luoxi/cellnet/codec/protoplus"
	default:
